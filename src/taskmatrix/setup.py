...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'obstacle_detection = ' + \
            'taskmatrix.turtlebot3_obstacle_detection.main:main',
            'patrol_client = ' + \
            'taskmatrix.turtlebot3_patrol_client.main:main',
            'patrol_server = ' + \
            'taskmatrix.turtlebot3_patrol_server.main:main',
            'position_control = ' + \
            'taskmatrix.turtlebot3_position_control.main:main',
        ],
    },
)
