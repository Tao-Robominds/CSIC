...
export GAZEBO_MODEL_PATH=$GAZEBO_MODEL_PATH:/home/boringtao/ROS2/LRMR/src/drone/sjtu_drone_description/worlds/tunnel/tunnel_models

cd ~/.gazebo/models
mkdir -p tunnel
cp -r /home/boringtao/ROS2/LRMR/src/drone/sjtu_drone_description/worlds/tunnel_models/* ~/.gazebo/models/
```

Then run:
```
gazebo $(ros2 pkg prefix sjtu_drone_description)/worlds/tunnel/tunnel_world.sdf
gazebo /home/boringtao/ROS2/LRMR/src/drone/sjtu_drone_description/worlds/tunnel_world.sdf
```
